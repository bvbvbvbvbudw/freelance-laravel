<div class="contracts">
    ...
    <div class="contract contract_2 border_dashboard3 br-10 mt-24">
        ...
        <div class="contract_actions">
            <div><a href="#"
                    class="main_color_important button button_1 button-br_sm button_medium flex flex-center">Invite</a>
            </div>
            <div><a href="#" class="button button_2 button-br_sm button_medium flex flex-center">Save</a></div>
        </div>
    </div>
    <?php } ?>
</div>
