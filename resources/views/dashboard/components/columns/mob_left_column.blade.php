...
<nav class="mob_left_column left_column bg_secondary">
    <div class="left_panel_close_button"><img class="_icon_medium"
                                              src="../img/svg/icons/<?= $theme ?>/ic_close_48px.svg" alt=""></div>
    <div class="nav_category">
        ...
        <ul class="nav_category-list">
            <li><a href="{{route('mainPage')}}"><img class="_icon"
                                                     src="../img/svg/icons/<?= $theme ?>/icon _people_.svg">Creators I follow</a>
            </li>
            <li> <a href="{{route('viewEditProfilePage', auth()->user()->name)}}">My account</a></li>
            <li>
                <a href=""><img class="_icon" src="../img/svg/icons/<?= $theme ?>/logout.svg">Logout</a>
            </li>
        </ul>
    </div>
</nav>
