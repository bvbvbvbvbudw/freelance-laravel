    ...
    <div class="content">
        <form class="extra_form_block content-col2 gap-32">
            <div class="br-10 border_dashboard3  extra_form content-col2-main p-32-24 bg_secondary">
                <div class="membership_form_block">
                    ...
                    <div class="border_dashboard3  input_group">
                        <input class="input-transparent input_group_control" placeholder="What are you offering level name?">
                    </div>
                </div>
                <div class="membership_form_block">
            ...
            <textarea class="input-transparent input_group_control"
                      placeholder="Join the 60-minute group yoga session where we practice Vinyasa. Beginner-friendly."></textarea>
                    </div>
                </div>
                <div class="membership_form_block">
            ...
            <div class="border_dashboard3  extra_form_submit content-col2-aside-lg br-10 bg_secondary">
                ...
                <p class="s-20-s mt-20">Group yoga session</p>
