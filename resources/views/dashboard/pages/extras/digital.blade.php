        ...
        <div class="content">
                ...
                <div class="br-10 border_dashboard3  extra_form content-col2-main p-32-24 bg_secondary">
                    <div class="membership_form_block">
                        ...
                        <div class="border_dashboard3  input_group">
                            <input class="input-transparent input_group_control"
                                   placeholder="Taking Smart Notes (Ebook)/Instagram Close Friends Stories">
                        </div>
                    </div>
                    <div class="membership_form_block">
            ...
            <span class="extra_dropdow_text"><img class="_icon-big"
                    ...
                    <div class="membership_form_block">
                        ...
                        <div class="border_dashboard3  input_group">
            <textarea class="input-transparent input_group_control"
                      placeholder="Master the art of note-taking with this extensive guide. Available in PDF format."></textarea>
                        </div>
                    </div>
                    <div class="membership_form_block">
              ...
              <input type="checkbox" id="Advance5" /><label for="Advance5">Toggle</label>
                ...
                <div class="border_dashboard3  extra_form_submit content-col2-aside-lg br-10 bg_secondary">
                    ...
                    <p class="s-20-s mt-20">Taking Smart Notes (Ebook)/Instagram Close Friends Stories</p>
