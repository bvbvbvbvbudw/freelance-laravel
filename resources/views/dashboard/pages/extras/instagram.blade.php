...
{{--        @include('dashboard.components.columns.left_column')--}}
        <div class="content">
                ...
                <div class="br-10 border_dashboard3  extra_form content-col2-main p-32-24 bg_secondary">
                    <div class="membership_form_block">
                        ...
                        <div class="border_dashboard3  input_group">
                            <input class="input-transparent input_group_control" placeholder="Join Instagram Close Friends">
                        </div>
                    </div>
                    <div class="membership_form_block">
            ...
            <textarea style="height:100px" class="input-transparent input_group_control"
                      placeholder="For a one-off payment, you can get access to our Close Friends stories on Instagram. This is where we share our daily lives and sneak peeks of the latest projects on a more personal level than we do to the wider Instagram community."></textarea>
                        </div>
                    </div>
                    <div class="membership_form_block">
              ...
              <input type="checkbox" id="Advance5" /><label for="Advance5">Toggle</label>
                ...
                <div class="border_dashboard3  extra_form_submit content-col2-aside-lg br-10">
                    <h4 class="s-20 medium">Prefiew Extra</h4>
                    <img class="mt-20" src="../../img/png/extra_preview.png" alt="">
                    <p class="s-20-s mt-20">Join Instagram Close Friends</p>
