            ...
            <div class="profile_block p_post_block">
                <div class="profile_border1 br-20 p_post_1">
                    ...
                    <div class="p_post_actions">
                        <a href=""><img class="_icon_medium" src="../img/svg/icons/<?= $theme ?>/ic_favorite_border_48px4.svg"
                                        alt=""></a>
                        <a href=""><img class="_icon_medium" src="../img/svg/icons/<?= $theme ?>/ic_message_48px4.svg" alt=""></a>
                        <a href=""><img class="_icon_medium" src="../img/svg/icons/<?= $theme ?>/file_upload 4.svg" alt=""></a>
                    </div>
                </div>
