            ...
            <div class="dashboard_newpost_block dashboard_audio border_dashboard dashboard_block bg_secondary">
                ...
                <div class="mt-16">
                    <div class="audio_buttons">
                        <div class="br-20"><img class="_icon" src="/app/img/svg/icons/<?= $theme_reverse ?>/file_upload.svg">Upload
                            audio</div>
                        <div class="br-20"><img class="_icon"
                                                src="/app/img/svg/icons/<?= $theme_reverse ?>/ic_keyboard_voice_48px.svg">Record audio
                        </div>
                    </div>
                    <div class="mt-16">
